  ...
  return (
    <>
      ...
      <div className="relative flex items-center group ">
        ...
        <div
          ref={slider}
          className="w-full sm:h-[150px] md:h-[180px] lg:h-[210px] overflow-x-scroll whitespace-nowrap scroll-smooth scrollbar-hide relative overflow-y-hidden pt-4 pb-4"
        >
          {movies.map((item, id) => {
            return (
              item.backdrop_path && (
